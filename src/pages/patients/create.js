...
export const PatientCreate = () => {
    ...
    return (_jsx(Create, { saveButtonProps: saveButtonProps, children: _jsxs(Form, { ...formProps, layout: "vertical", children: [_jsx(Form.Item, { label: "Name", name: "name", rules: [{ required: true, message: "Please input patient name!" }], children: _jsx(Input, { placeholder: "Enter patient name" }) }), _jsx(Form.Item, { label: "Email", name: "email", rules: [
